...
// Close modal on Escape key; close help drawer on Escape too
document.addEventListener('keydown', (e) => {
  if (e.key === 'Escape') {
    // Only close help (not onboarding — onboarding is mandatory)
    const helpDrawer = document.getElementById('help-drawer');
    if (helpDrawer && helpDrawer.classList.contains('active')) {
      closeHelp();
      return;
    }
    closeModal();
